  ...
  if (loading && !alerts) {
    return (
      <div className="bg-slate-800/50 rounded-xl border border-slate-700 overflow-hidden">
        <div id="live-alerts" className="jump-scroll-target px-4 py-2.5 bg-red-500/10 border-b border-red-500/20">
    ...
    return (
      <div className="bg-slate-800/50 rounded-xl border border-slate-700 overflow-hidden">
        <div className="px-4 py-2.5 bg-red-500/10 border-b border-red-500/20 flex items-center justify-between">
          <h3 id="live-alerts" className="jump-scroll-target text-sm font-semibold text-red-400">Live Alerts</h3>
