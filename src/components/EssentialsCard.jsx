 ...
 *
 * Shows 3-4 product highlights from the chosen variant. Each item is a small
 * pill linking to /prep#category-anchor (NOT direct to Amazon — we want users
 * to land on the comprehensive prep guide first for trust + better conversion).
 *
...
export default function EssentialsCard({ variant, placement }) {
  ...
  return (
    <section
      ...
      className="rounded-xl border border-slate-700 bg-slate-800/60 p-4 sm:p-5"
    >
