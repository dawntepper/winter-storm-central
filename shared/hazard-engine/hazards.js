...
export const HAZARD_CONFIGS = {
  ...
  // Future pages — config ready, not in initial sitemap launch set unless launch:true
  'flash-flood-watch': {
    ...
    intro: 'Track active flash flood watches across the United States.',
    icon: flood.icon,
    severityColor: flood.color,
    radarCategory: 'flood',
    radarFilter: 'flash-flood-watch',
    seoTitle: 'Flash Flood Watches Today & Live Radar | StormTracking',
    seoDescription: 'Track active flash flood watches with live radar and National Weather Service alerts.',
  ...
  'blizzard-warning': {
    ...
    shortLabel: 'Blizzard',
    intro: 'Track active blizzard warnings across the United States.',
    ...
    seoDescription: 'Track active blizzard warnings with live radar and National Weather Service alerts.',
  ...
  'winter-storm-warning': {
    ...
    intro: 'Track active winter storm warnings across the United States.',
    icon: ALERT_CATEGORIES.winter.icon,
    severityColor: ALERT_CATEGORIES.winter.color,
    radarCategory: 'winter',
    radarFilter: 'winter-storm-warning',
    seoTitle: 'Winter Storm Warnings Today & Live Radar | StormTracking',
    seoDescription: 'Track active winter storm warnings with live radar and National Weather Service alerts.',
  ...
  'ice-storm-warning': {
    ...
    intro: 'Track active ice storm warnings across the United States.',
    icon: ALERT_CATEGORIES.winter.icon,
    severityColor: ALERT_CATEGORIES.winter.color,
    radarCategory: 'winter',
    radarFilter: 'ice-storm-warning',
    seoTitle: 'Ice Storm Warnings Today & Live Radar | StormTracking',
    seoDescription: 'Track active ice storm warnings with live radar and National Weather Service alerts.',
  ...
  'high-wind-warning': {
    ...
    intro: 'Track active high wind warnings across the United States.',
    icon: severe.icon,
    severityColor: severe.color,
    radarCategory: 'severe',
    radarFilter: 'high-wind-warning',
    seoTitle: 'High Wind Warnings Today & Live Radar | StormTracking',
    seoDescription: 'Track active high wind warnings with live radar and National Weather Service alerts.',
    zeroActiveDescription: 'There are currently no active high wind warnings in the United States.',
    relatedHazards: ['severe-thunderstorm-warning'],
  ...
  'excessive-heat-warning': {
    ...
    intro: 'Track active excessive heat warnings across the United States.',
    ...
    seoDescription: 'Track active excessive heat warnings and National Weather Service alerts.',
  ...
  'red-flag-warning': {
    ...
    shortLabel: 'Red Flag',
    intro: 'Track active red flag warnings across the United States.',
    ...
    seoDescription: 'Track active red flag warnings and National Weather Service alerts.',
  ...
  'storm-surge-warning': {
    ...
    intro: 'Track active storm surge warnings across the United States.',
    icon: tropical.icon,
    severityColor: tropical.color,
    radarCategory: 'tropical',
    radarFilter: 'storm-surge-warning',
    seoTitle: 'Storm Surge Warnings Today & Live Radar | StormTracking',
    seoDescription: 'Track active storm surge warnings with live radar and National Weather Service alerts.',
    zeroActiveDescription: 'There are currently no active storm surge warnings in the United States.',
    relatedHazards: ['hurricane-warning', 'tropical-storm-warning'],
  ...
  'extreme-wind-warning': {
    ...
    intro: 'Track active extreme wind warnings across the United States.',
    icon: tropical.icon,
    severityColor: tropical.color,
    radarCategory: 'tropical',
    radarFilter: 'extreme-wind-warning',
    seoTitle: 'Extreme Wind Warnings Today | StormTracking',
    seoDescription: 'Track active extreme wind warnings and National Weather Service alerts.',
